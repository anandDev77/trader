...
<html lang="en">
  ...
  <body>
    ...
    <p/>
    Login to IBM Stock Trader - test 3
    <form method="post"/>
      <table>
        <tr>
      ...
      <br/>
      <input type="submit" name="submit" value="Submit" style="font-family: sans-serif; font-size: 16px; background-color: red; color: white;">
    </form>
    <br/>
